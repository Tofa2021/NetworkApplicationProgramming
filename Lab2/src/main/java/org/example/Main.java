        ...
        while (true) {
            ...
            switch (scanInt()) {
                ...
                case 1 -> {
                    ...
                    int workExperience = scanBorderInt(0, 100);
                    EmployeeService.add(new Developer(name, workExperience));
                }
                case 4 -> {
                ...
                case 10 -> {
                    ...
                    int minWorkExperience = scanBorderInt(0, 100);
                    System.out.println("Введите максимальный стаж");
                    int maxWorkExperience = scanBorderInt(0, 100);
